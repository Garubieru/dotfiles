...
theme.font                                      = "JetBrains Mono Nerd Font 10.5"
theme.fg_normal                                 = "#DDDDFF"
theme.fg_focus                                  = "#7da6ff"
...
theme.border_focus                              = "#ad8ee6"
theme.border_marked                             = "#CC9393"
theme.tasklist_bg_focus                         = "#ad8ee6"
...
nconf.defaults.border_width = 1
nconf.defaults.border_color = "#acb0d0"
nconf.defaults.margin = 10
nconf.defaults.text = "Boo!"
nconf.defaults.timeout = 3
nconf.defaults.max_width = 400
nconf.defaults.max_height = 200
nconf.padding = 8
nconf.presets.critical.bg = "#FE634E"
nconf.presets.critical.fg = "#fefefa"
nconf.presets.low.bg = theme.bg_normal
nconf.presets.normal.bg = theme.bg_normal
nconf.defaults.icon_size = 64
nconf.spacing = 8
nconf.font = theme.font
nconf.defaults.shape = rrect(10)
...
local weather = lain.widget.weather({
    APPID = "d032f6c40fe7b868e92011a3c463dba1",
    city_id = 3448439,
    settings = function()
...
theme.volume.widget:buttons(awful.util.table.join(
    awful.button({}, 4, function()
        awful.util.spawn("amixer set 'Headset,1' 1%+")
        theme.volume.update()
    end),
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font,
            markup("#ad8ee6", " " .. string.format("%06.1f", net_now.received))
            .. " " ..
            markup("#449dab", " " .. string.format("%06.1f", net_now.sent) .. " ")))
    end
})
